...
class IRPO_Algorithm(nn.Module):
    ...
    def define_outer_policy(self):
        ...
        self.policy = IRPO_Learner(
            ...
            timesteps=self.args.timesteps,
            num_exploratory_updates=self.args.num_exploratory_updates,
            base_policy_update_mode=self.args.base_policy_update_mode,
            base_actor_lr=self.args.base_actor_lr,
            exploratory_actor_lr=self.args.exploratory_actor_lr,
